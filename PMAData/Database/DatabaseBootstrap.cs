    ...
    public class DatabaseBootstrap : IDatabaseBootstrap
    {
        ...
        public DatabaseBootstrap(DatabaseConfig databaseConfig)
        {
            ...
            this.tableConfiguration = new Dictionary<string, string>() {
                { "Movie", "Create Table Movie (ID INT NOT NULL, Title VARCHAR(1000) NOT NULL, Year VARCHAR(4) NOT NULL, LastPlayed DATETIME NULL, Added DATETIME NULL);" },
                { "TVShow", "Create Table TVShow (ID INT NOT NULL, Title VARCHAR(1000) NOT NULL, Year VARCHAR(4) NOT NULL, LastPlayed DATETIME NULL, Added DATETIME NULL);" },
